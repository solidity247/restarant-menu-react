...
export default function AdminItemCard({ itemDetails, setIsForm }) {
  ...
  return (
    <div className="admin-item-card">
      ...
      ></div>
      <div className="aic-title admin-item-line-element">
        {" "}
        {itemDetails.title}
      </div>
      <div className="aic-category admin-item-line-element">
        {" "}
        {itemDetails.category}
      </div>
      <div className="aic-description admin-item-line-element">
        {" "}
        {itemDetails.desc}
      </div>
      <div className="aic-img-url admin-item-line-element">
        {" "}
        {itemDetails.img}
      </div>
      <div className="aic-price admin-item-line-element">
        {" "}
        ${itemDetails.price}
      </div>
